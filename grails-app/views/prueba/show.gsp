...
<html>
    ...
    <body>
        ...
        <div id="show-prueba" class="content scaffold-show" role="main">
            ...
            <f:display bean="prueba" />
            <g:form resource="${this.prueba}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.prueba}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
