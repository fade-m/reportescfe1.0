...
<html>
    ...
    <body>
        ...
        <div id="show-reporte" class="content scaffold-show" role="main">
            ...
            <f:display bean="reporte" />
            <g:form resource="${this.reporte}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.reporte}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
