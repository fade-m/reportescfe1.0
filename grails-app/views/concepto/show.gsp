...
<html>
    ...
    <body>
        ...
        <div id="show-concepto" class="content scaffold-show" role="main">
            ...
            <f:display bean="concepto" />
            <g:form resource="${this.concepto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.concepto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
