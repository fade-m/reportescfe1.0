...
<html>
    ...
    <body>
        ...
        <div id="show-semana" class="content scaffold-show" role="main">
            ...
            <f:display bean="semana" />
            <g:form resource="${this.semana}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.semana}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
